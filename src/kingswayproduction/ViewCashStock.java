 ...
 * @author Sanari
 */
public class ViewCashStock extends javax.swing.JFrame {

     Connection con = null;
    ResultSet rs = null;
    PreparedStatement pst = null;
    public ViewCashStock() {
        initComponents();
     ...
     private void UpdateTable(){
        ...
        try{
        String sql ="Select * from DetailedMaterial where Target='Cash'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            String reportSource = "C://Kinsway_Production_Report//cashstockreport.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCashStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCashStock().setVisible(true);
            }
        });
    }
